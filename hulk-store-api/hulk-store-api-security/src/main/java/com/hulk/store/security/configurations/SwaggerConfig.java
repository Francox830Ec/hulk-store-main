package com.hulk.store.security.configurations;
...
public class SwaggerConfig {
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.hulk.store.security.controllers"))
            ...
            .tags(new Tag(CategoryRest.CATEGORY_REST_SECURITY, CategoryRest.CATEGORY_REST_SECURITY_DESCRIPTION));
    }
