package com.hulk.store.shopping.cart.configurations;
...
public class SwaggerConfig {
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.hulk.store.shopping.cart.controllers"))
            ...
            .tags(new Tag(CategoryRest.CATEGORY_REST_SHOPPING_CART, CategoryRest.CATEGORY_REST_SHOPPING_CART_DESCRIPTION));
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("Hulk Store Shopping Cart API")
